...
export default class User extends Component {
  ...
  _setUserData = async () => {
    ...
    try {
      await NearIT.setUserData("chiave", null);
  ...
  _setMultiChoiceUserData = async () => {
    console.log("Setting Multiple choice UserData...");
    try {
      await NearIT.setMultiChoiceUserData("interests", null);
      console.log("Successfully set UserData!");
      this.props.showMessage(`Multiple choice UserData set!`, whoIcon);
    } catch (err) {
      console.log("Could NOT set Multiple choice UserData...", err);
    }
  };
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Button
          label="Set Multichoice UserData"
          accessibilityLabel="Set Multichoice UserData"
          onPress={this._setMultiChoiceUserData}
          style={styles.actionButton}
        />
